...
func (h *Handler) CreateEvent(c *gin.Context) {
	...
	event := models.Event{
		...
		MapURL:      req.MapURL,
		//StartAt:     (req.StartAt),
		//RegOpenAt:   req.RegOpenAt,
		//RegCloseAt:  req.RegCloseAt,
		Status:      status,
	...
	created, err := h.Service.CreateEvent(c.Request.Context(), event)
	if err != nil {
...
func (h *Handler) UpdateEvent(c *gin.Context) {
	...
	//event.RegOpenAt = req.RegOpenAt
	//event.RegCloseAt = req.RegCloseAt
